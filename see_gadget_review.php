...
<td align="center">    
    ...
    <br><button type="button" value="YES_RECOMMEND" onclick="window.location.href='write_review.php'">YES!</button> <button type="button" value="NO_RECOMMEND" onclick="window.location.href='#'">No!</button>
</td>
...
<table align="center" width="1500" height="300">
    <tr>
        ...
        <td>
            <img src="7.png" alt="Stars" height="30" width="150">
            <br><h3>ASUS X55179</h3>
            <br>I purchase the micromax xl2 phone good phone big screen 5.5 inch thats nice and resulatin is qhd and ips screen and processor is good ram is good colour is avi white and black now most important battery is 2500mh and good life camera also good i am use this phone. micromax canvas series is good. enjoy for movies and video and gaming. enjoy for heavy games nice phone. 
        </td>
    </tr>
</table>
<table align="center" width="1500" height="300">
