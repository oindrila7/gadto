...
<body>
    <div style="padding:10; text-align:right;">
        ...
        <a href="index.php"><img style="float: left; padding-left: 10"src="gadto.jpg" width="100" height="60"></a>
        ...
        <table align="center" height="200" width="400" style="padding-top: 175px">
            ...
            <tr>
                <td>
                    ...
                    <input type="submit" name="signIn" value="Sign In ->>" style="height:30px; width:150px";/>
                </td>
            </tr>
        </table>
    </form>
...
if(isset($_COOKIE['loggedtime'])){
    $logTime = $_COOKIE['loggedtime'];
}
/* if(isset($_COOKIE['username']) && isset($_COOKIE['lastVisit']))
    $visit = $_COOKIE['lastVisit'];
    echo $visit;
*/
?>
