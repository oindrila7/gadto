...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 27, 2018 at 03:25 PM
...
(8, 'arman0010', 'tipu0010@gmail.com', '11111111', 'Arman', 'Hossen', 1676568244, 'sa', 'always active'),
...
(15, 'RahateFesf', 'rahat@gmail.com', '22222222', 'Rashed', 'Ahmed', 1712345678, 'admin', 'pending'),
...
--
ALTER TABLE `review_type`
  MODIFY `r_type_id` int(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `user_confirmation`
  MODIFY `u_conf_id` int(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `notification`
  ADD CONSTRAINT `notification_ibfk_1` FOREIGN KEY (`user_name`) REFERENCES `user_info` (`user_name`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `payment_info`
--
ALTER TABLE `payment_info`
  ADD CONSTRAINT `payment_info_ibfk_1` FOREIGN KEY (`ad_id`) REFERENCES `ad_info` (`ad_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `payment_info_ibfk_2` FOREIGN KEY (`card_no`) REFERENCES `card_info` (`card_no`) ON DELETE CASCADE ON UPDATE CASCADE;
